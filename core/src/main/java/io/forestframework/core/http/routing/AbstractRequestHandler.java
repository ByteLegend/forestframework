...
//    protected <T> T resolveArgument(Routing routing, int index, Class<T> argumentType, ArgumentInjector injectableParameters) {
...
//        } else {
//            return (T) resolver.resolveParameter(routing, injectableParameters.resolve(RoutingContext.class, null), index);
//        }
//    }
//
//    protected Object[] resolveArguments(Routing routing, ArgumentInjector injectableParameters) {
...
//        return resolveArgumentsAndInvokeHandler(routing, new ArgumentInjector(injector).with(context));
//    }
//
//    protected <T> CompletableFuture<T> resolveArgumentsAndInvokeHandler(Routing routing, ArgumentInjector injectableParameters) {
