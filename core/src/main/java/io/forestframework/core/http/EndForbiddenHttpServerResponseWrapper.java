...
public class EndForbiddenHttpServerResponseWrapper implements HttpServerResponse {
    ...
    public void realEnd(String chunk, Handler<AsyncResult<Void>> handler) {
        delegate.end(chunk, handler);
    }

    public Future<Void> realEnd(String chunk, String enc) {
        return delegate.end(chunk, enc);
    }

    public void realEnd(String chunk, String enc, Handler<AsyncResult<Void>> handler) {
        delegate.end(chunk, enc, handler);
    }

    public Future<Void> realEnd(Buffer chunk) {
        return delegate.end(chunk);
    }

    public void realEnd(Buffer chunk, Handler<AsyncResult<Void>> handler) {
        delegate.end(chunk, handler);
    }

    public Future<Void> realEnd() {
        return delegate.end();
    }

    @Override
    public Future<Void> end(String chunk) {
        throw new UnsupportedOperationException("Don't call end method yourself, we'll do it for you.");
    }
