...
/**
 * Don't touch this. This is a hack for {@link io.forestframework.core.config.Config} injection.
 */
class UnsafeHack {
    private static final Logger LOGGER = LoggerFactory.getLogger(UnsafeHack.class);
