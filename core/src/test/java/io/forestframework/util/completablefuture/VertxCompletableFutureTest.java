...
public class VertxCompletableFutureTest {
    ...
    public void testToVertxFuture(TestContext tc) {
        ...
        ((Promise) awaitedFuture.toFuture()).complete(42);
    ...
    public void testFromVertxFuture(TestContext tc) {
        ...
        Future<Integer> vertxFuture1 = promise1.future();
        Future<Integer> vertxFuture2 = promise2.future();
        ...
        promise2.fail(new Exception("My bad"));
    }
}
